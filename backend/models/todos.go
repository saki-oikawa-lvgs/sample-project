...
var TodoWhere = struct {
	...
	Text:   whereHelpernull_String{field: "\"todos\".\"text\""},
	Done:   whereHelpernull_Bool{field: "\"todos\".\"done\""},
	UserID: whereHelpernull_String{field: "\"todos\".\"user_id\""},
}
...
var (
	...
	todoColumnsWithoutDefault = []string{"id", "text", "done", "user_id"}
